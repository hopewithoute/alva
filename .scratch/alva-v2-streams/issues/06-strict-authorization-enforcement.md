...
## Acceptance criteria
- [x] Omitted `authorize_with` policies in `handle_subscribe_signal` correctly fail or strictly deny access instead of defaulting to `true`.
- [x] Subscriptions cannot be established without explicit Ash policy consent.
