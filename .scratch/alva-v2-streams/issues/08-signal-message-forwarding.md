...
## Acceptance criteria
- [ ] Valid signal PubSub messages are properly captured in `handle_info`.
- [ ] The `signals` array in the returned projection operation payload correctly forwards these events to the client instead of always being empty.
