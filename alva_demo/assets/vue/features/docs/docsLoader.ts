...
const guideModules: Record<string, string> = import.meta.glob<string>(
  "../../../../../alva/guides/*.md",
  {
    query: "?raw",
    import: "default",
...
> = {
  ...
  "04-queries-and-actions.md": {
    ...
    description:
      "Reactive data fetching with useAlvaQuery and direct event execution with useAlvaApi."
  },
  ...
  "06-frontend-composables.md": {
    ...
    category: "Frontend Composables",
    description:
      "Unified API reference for useAlvaQuery, useAlvaForm, use_signal_state, and use_action_upload."
  },
  "07-uploads.md": {
    slug: "uploads",
  ...
  "08-streams.md": {
    ...
    category: "Advanced Integrations",
    description:
      "Zero-memory collection streaming, dynamic scope assigns, and automatic mutation synchronization."
  },
  "09-signals.md": {
    slug: "signals",
