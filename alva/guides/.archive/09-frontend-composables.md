...
This reference guide provides a complete overview of all auto-generated Vue 3 composables provided by Alva V2 (`useAlvaQuery`, `useAlvaForm`, `use_<signal>_state`, `use_<action>_upload`).
...
defmodule AlvaDemo.Catalog.Product do
  ...
  alva do
    event(:catalog_list_products, name: "catalog.list_products", action: :list, enable_filter: true)
...
// Auto-fetches when `productId.value` changes!
